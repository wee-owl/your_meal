...
export const modalFieldsetRadio = document.querySelector('.modal-delivery__fieldset-radio');
export const modalRadioPickup = document.querySelector('.modal-delivery__radio-pickup');
export const modalRadioDelivery = document.querySelector('.modal-delivery__radio-delivery');
export const modalFieldsetInput = document.querySelector('.modal-delivery__fieldset-input-address');
